...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARDUINO_NANO_HEADER_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_TI_ADS1220_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_L432KC_STM32L432XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KERNEL_LOG_LEVEL_OFF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_ADS1220, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_ADS1220_WAIT_FOR_COMPLETION_TIMEOUT_MS, 250);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SPI_LOG_LEVEL_OFF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32_USB_COMMON_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BUFFER_SIZE, 32768);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_LOG_LEVEL, 2);
